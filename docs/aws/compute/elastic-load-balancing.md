...
<img style={{ width: '96px', overflowX: 'auto' }} src="/img/aws/logo/elb.png" alt="AWS ELB LOGO" />
</div>
...
<img style={{ width: '200px', overflowX: 'auto' }} src="/img/aws/elb-routing-round-robin.jpg" alt="ELB Routing Round Robin" />

### Least Connections

Routes traffic to the server with the fewest active connections, maintaining a balanced load.

<img style={{ width: '200px', overflowX: 'auto' }} src="/img/aws/elb-routing-least-connection.jpg" alt="ELB Routing Least Connections" />

### IP Hash

Uses the client’s IP address to consistently route traffic to the same server.

<img style={{ width: '200px', overflowX: 'auto' }} src="/img/aws/elb-routing-ip-hash.jpg" alt="ELB Routing IP Hash" />

### Least Response Time

Directs traffic to the server with the fastest response time, minimizing latency.

<img style={{ width: '200px', overflowX: 'auto' }} src="/img/aws/elb-routing-least-response-time.jpg" alt="ELB Routing Least Response Time" />
...
<img style={{ width: '100%', overflowX: 'auto' }} src="/img/aws/elb-low-demand.png" alt="ELB Low-demand period"/>
...
<img style={{ width: '100%', overflowX: 'auto' }} src="/img/aws/elb-high-demand.png" alt="ELB High-demand period"/>
...
<img style={{ width: '100%', overflowX: 'auto' }} src="/img/aws/elb-load-balancing.png" alt="ELB Load Balncing"/>
