...
<img style={{ width: '96px', overflowX: 'auto' }} src="/img/aws/logo/elastic-beanstalk.png" alt="AWS Elastic Beanstalk LOGO" />
</div>
...
- [queues](https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/Welcome.html)
