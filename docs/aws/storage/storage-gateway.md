...
<img style={{ width: '96px', overflowX: 'auto' }} src="/img/aws/aws-logo-storage-gateway.png" alt="AWS Storage Gateway" />
</div>
...
<div class="aws__ImageCentered" >
<img style={{ background: '#f6f9fd', width: '500px', overflowX: 'auto' }} src="/img/aws/storage-gateway-overview.png" alt="Storage Gateway Overview" />
</div>
...
**Cached Volume Mode:** Stores primary data in S3 while caching frequently accessed data locally.
...
**Stored Volume Mode:** Keeps the complete dataset locally while asynchronously backing it up to AWS as EBS snapshots.
