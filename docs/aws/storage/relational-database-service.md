...
<img style={{ width: '96px', overflowX: 'auto' }} src="/img/aws/logo/amazon-rds.png" alt="Amazon RDS" />
</div>
...
Amazon RDS supports six database engines including Amazon Aurora, MySQL, PostgreSQL, Microsoft SQL Server, MariaDB, and Oracle Database, enabling you to choose the best engine for your specific application requirements.
